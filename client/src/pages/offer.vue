...
<template>
    ...
    <h1>OGLOSZENIE FULL</h1>
    <div class="panel">
    <div id="carouselExampleControls" class="carousel slide" data-ride="carousel">
  <div class="carousel-inner">
    <div class="carousel-item active" v-for="Photo in offer.Photos">
        <img class="foto" :src="'/src/assets/uploads/' + offer.Photos[0]" alt="zdjecie">
    </div>
    <div class="carousel-item" v-for="Photo in offer.Photos">
        <img class="foto" :src="'/src/assets/uploads/' + Photo" alt="zdjecie">
    </div>
  </div>
